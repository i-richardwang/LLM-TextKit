...
class Category(BaseModel):
    """Represents a clustering category"""

    id: int = Field(..., description="Category ID, starting from 1")
    name: str = Field(..., description="Concise and clear category label")
    description: str = Field(
        ..., description="Detailed description explaining the category's characteristics and how it differs from others"
    )


class Categories(BaseModel):
    """All categories after clustering"""

    categories: List[Category] = Field(..., description="List of all categories obtained from clustering")
...
class ClassificationResult(BaseModel):
    ...
    ] = Field(..., description="List of classification results for all texts")


# System message for initial category generation
...
# Human message template for initial category generation
...
# System message for merging and optimizing categories
...
# Human message template for merging and optimizing categories
...
# System message for single-label text classification
...
# System message for multi-label text classification
...
# Human message template for text classification
